...
const file_v1_api_proto_rawDesc = "" +
	"\n" +
	"\fv1/api.proto\x12\fgophkeper.v1\"*\n" +
	...
	"\x03app\x18\x02 \x01(\v2\x11.gophkeper.v1.AppR\x03app\"2\n" +
	...
	"\asession\x18\x01 \x01(\v2\x15.gophkeper.v1.SessionR\asession\"D\n" +
	"\x11UploadDataRequest\x12/\n" +
	"\asession\x18\x01 \x01(\v2\x15.gophkeper.v1.SessionR\asession\"\x14\n" +
	"\x12UploadDataResponse\"F\n" +
	"\x13DownloadDataRequest\x12/\n" +
	"\asession\x18\x01 \x01(\v2\x15.gophkeper.v1.SessionR\asession\"G\n" +
	"\x14DownloadDataResponse\x12/\n" +
	"\asession\x18\x01 \x01(\v2\x15.gophkeper.v1.SessionR\asession\"D\n" +
	"\x11DeleteDataRequest\x12/\n" +
	"\asession\x18\x01 \x01(\v2\x15.gophkeper.v1.SessionR\asession\"\x14\n" +
	"\x12DeleteDataResponse\"B\n" +
	"\x0fListDataRequest\x12/\n" +
	"\asession\x18\x01 \x01(\v2\x15.gophkeper.v1.SessionR\asession\"\x12\n" +
	"\x10ListDataResponse\"\x1c\n" +
	"\x03App\x12\x15\n" +
	...
	"\rKeeperService\x12O\n" +
	"\n" +
	"UploadData\x12\x1f.gophkeper.v1.UploadDataRequest\x1a .gophkeper.v1.UploadDataResponse\x12U\n" +
	"\fDownloadData\x12!.gophkeper.v1.DownloadDataRequest\x1a\".gophkeper.v1.DownloadDataResponse\x12I\n" +
	"\bListData\x12\x1d.gophkeper.v1.ListDataRequest\x1a\x1e.gophkeper.v1.ListDataResponse\x12O\n" +
	"\n" +
	"DeleteData\x12\x1f.gophkeper.v1.DeleteDataRequest\x1a .gophkeper.v1.DeleteDataResponseB8Z6github.com/oleshko-g/gophkeeper/proto/api/v1;keeper_v1b\beditionsp\xe8\a"
...
var file_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_v1_api_proto_goTypes = []any{
	(*RegisterRequest)(nil),      // 0: gophkeper.v1.RegisterRequest
	(*RegisterResponse)(nil),     // 1: gophkeper.v1.RegisterResponse
	(*AuthorizeRequest)(nil),     // 2: gophkeper.v1.AuthorizeRequest
	(*AuthorizeResponse)(nil),    // 3: gophkeper.v1.AuthorizeResponse
	(*ConnectRequest)(nil),       // 4: gophkeper.v1.ConnectRequest
	(*ConnectResponse)(nil),      // 5: gophkeper.v1.ConnectResponse
	(*UploadDataRequest)(nil),    // 6: gophkeper.v1.UploadDataRequest
	(*UploadDataResponse)(nil),   // 7: gophkeper.v1.UploadDataResponse
	(*DownloadDataRequest)(nil),  // 8: gophkeper.v1.DownloadDataRequest
	(*DownloadDataResponse)(nil), // 9: gophkeper.v1.DownloadDataResponse
	(*DeleteDataRequest)(nil),    // 10: gophkeper.v1.DeleteDataRequest
	(*DeleteDataResponse)(nil),   // 11: gophkeper.v1.DeleteDataResponse
	(*ListDataRequest)(nil),      // 12: gophkeper.v1.ListDataRequest
	(*ListDataResponse)(nil),     // 13: gophkeper.v1.ListDataResponse
	(*App)(nil),                  // 14: gophkeper.v1.App
	(*Session)(nil),              // 15: gophkeper.v1.Session
}
var file_v1_api_proto_depIdxs = []int32{
	14, // 0: gophkeper.v1.AuthorizeRequest.app:type_name -> gophkeper.v1.App
	15, // 1: gophkeper.v1.ConnectResponse.session:type_name -> gophkeper.v1.Session
	15, // 2: gophkeper.v1.UploadDataRequest.session:type_name -> gophkeper.v1.Session
	15, // 3: gophkeper.v1.DownloadDataRequest.session:type_name -> gophkeper.v1.Session
	...
	11, // 20: gophkeper.v1.KeeperService.DeleteData:output_type -> gophkeper.v1.DeleteDataResponse
